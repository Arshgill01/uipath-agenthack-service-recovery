...
| 4:15-4:35 | `README.md` coding-agent section, `docs/submission/CODING_AGENT_PROOF_LOG.md`, and `docs/submission/coding_agent_evidence_manifest.json` | "Codex was the coding agent used to build the core, evals, UiPath validation runbooks, product-feedback evidence, and submission pack. UiPath remains the runtime orchestration and governance layer." | Do not imply Codex is part of runtime case authority. Do not quote private chat logs. |
...
- Coding-agent proof in README/proof log/manifest plus validation output.
