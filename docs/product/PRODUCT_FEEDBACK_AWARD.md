...
- For demo polish, use the custom evidence-packet view. Repair the generated page only if Studio/UI exposes an editable binding path and the repaired task can be revalidated end to end.
