...
- Data Fabric persistence: entity create/readback worked, but record insert/import could not map the required `case_id` field despite multiple valid-looking payload shapes.
