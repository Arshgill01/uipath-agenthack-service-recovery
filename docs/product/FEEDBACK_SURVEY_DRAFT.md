...
- Do not claim broad Data Fabric audit storage; the observed path proves E-004 CSV row creation/readback by ID only, while custom payload readback and direct JSON insert remain unvalidated.
